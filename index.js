    ...
    axios(url).then((res) => {
      ...
      $("figure", html).each(function () {
        ...
        thumbnails.push({
          name: name,
          slug: slug,
          url: "https://api-baotang.vercel.app/truyentranh" + "/" + slug,
    ...
    axios(url).then((res) => {
      ...
      $(".image", html).each(function () {
        ...
        thumbnails.push({
          ...
          slug: slug.replace("/", ""),
          url:
            "https://api-baotang.vercel.app/truyentranh/" +
      ...
      $("article", html).each(function () {
        ...
        $(".list-chapter > nav > ul > li", html).each(function () {
          ...
          listChapters.push({
            ...
            idLinks: idLinks,
            demo:
              "https://api-baotang.vercel.app/comic" +
              "/" +
              nextLinks +
              "/" +
              idLinks +
    ...
    axios(url).then((res) => {
      ...
      $("select option", html).each(function () {
        ...
        allChapters.push({
          ...
          nextHref: nextHref,
          idHref: idHref,
          demo: `https://api-baotang.vercel.app/comic/${newHref}/${nextHref}/${idHref}`,
        });
      });
      detailChapter.push({
        listImages: images,
